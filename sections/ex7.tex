...
To put a metric on the steering behaviour, I calculated the total steering input for each run in degrees. It was computed by summing the absolute values of the change in steering angle between every two consecutive time steps [equation \ref{eq:7.1}].
