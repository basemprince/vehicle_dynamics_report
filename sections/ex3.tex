...
From Figure \ref{llv}, the magnitude of the longitudinal velocity is higher than the lateral velocity. This matches what was expected as the vehicle mainly moves longitudinally and only laterally while slipping.
...
The INS velocity is sometimes bigger than the hall effect calculated speeds, especially during braking [partial wheel lock]. There is no obvious difference between them (Figure \ref{lsvt}).

\textbf{Q. Evaluate the lateral acceleration using the relation with the yaw-rate and the longitudinal speed.}

        \begin{figure}[ht]
        \includegraphics[width=10cm]{ex3/ex-34.eps}
        \centering
