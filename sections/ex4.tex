...
During acceleration, the lateral forces $\fy$ across all tires increase because the vertical forces $\fz$ increased. The lateral forces rely on the vertical forces in the pacejka calculations, which is why both the $\fy$ and $\fz$ profiles match for front and rear tires.
